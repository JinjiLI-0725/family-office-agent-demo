...
export const uiCopy = {
  en: {
    ...
    mobileProfileTab: "客户画像 / Client Profile",
    mobileFollowUpTab: "跟进卡 / Follow-up Card",
    mobileRoutingTab: "顾问流转 / Advisor Routing",
    mobileMemo: "Memo & Actions",
    mobileInternalRouting: "Internal Routing",
    advisorSequence: "Advisor Sequence",
  ...
  zh: {
    ...
    mobileRoutingTab: "顾问流转 / Advisor Routing",
    mobileMemo: "备忘录与行动",
    mobileInternalRouting: "内部流转",
    advisorSequence: "顾问流转顺序",
    safetyTitle: "安全边界",
