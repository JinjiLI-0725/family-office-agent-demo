...
export const uiCopy = {
  en: {
    product: "Family Office Client Intake Agent",
    tagline: "Family Office Client Intake Agent",
  ...
  zh: {
    product: "家族办公室客户引进 Agent",
    tagline: "家族办公室客户引进 Agent",
    thesis: "整理潜在家族客户画像，识别顾问服务需求，并生成供家族办公室与保险顾问内部跟进的客户引进卡。",
    ...
    scenarioSubtitle: "选择客户引进或内部转介场景，由 Agent 生成客户引进卡。",
    domain: "顾问领域",
    riskCount: "需求数量",
    review: "复核",
    agentTaskRunner: "客户引进卡运行器",
    selectedTask: "已选引进任务",
    runAgent: "生成卡片",
    runReady: "Agent 就绪",
    safetyTitle: "安全边界",
...
export const prompts: Prompt[] = [
  {
    ...
    description: { en: "Prepare an internal Client Intake Card for first advisor triage.", zh: "生成内部客户引进卡，供顾问初步分流。" },
    review: { en: "Family Office Principal + Insurance Advisor", zh: "家族办公室负责人 + 保险顾问" },
    runSummary: { en: "The Agent organized a private banker referral into a Client Intake Card, identified succession and insurance-related needs, and routed the case for advisor review.", zh: "Agent 将私人银行转介整理为客户引进卡，识别传承与保险相关需求，并建议顾问复核流转。" },
    riskCount: 6,
  ...
  },
  {
    ...
    command: { en: "Consolidate this week’s referral cards, open missing information, follow-up priority, and required review teams for internal routing.", zh: "汇总本周客户引进卡、缺失资料、跟进优先级和所需复核团队，供内部流转。" },
...
export const agentRuns: Record<PromptId, AgentRunStep[]> = {
  health: [
    ...
    { name: { en: "Prepare referral card", zh: "生成客户引进卡" }, status: "Needs Human Approval", detail: { en: "Generated internal routing for family office principal, insurance advisor, and tax advisor review.", zh: "生成内部流转建议，交由家办负责人、保险顾问和税务顾问复核。" }, metadata: { en: "Follow-up Priority: High", zh: "跟进优先级：高" } },
  ],
  trust: [
...
export const agentResponses: Record<PromptId, AgentResponse> = {
  health: {
    ...
    preparedBy: { en: "Family Office Client Intake Agent", zh: "家族办公室客户引进 Agent" },
    memoReview: { en: "Family office, insurance, and tax advisor review", zh: "家办、保险与税务顾问复核" },
    memoStatus: { en: "Internal draft referral card", zh: "内部客户引进卡草稿" },
...
export const auditLogs: AuditLog[] = [
  { user: { en: "Relationship Manager", zh: "RM" }, role: { en: "Intake Owner", zh: "引进负责人" }, resource: { en: "Client Intake Card", zh: "客户引进卡" }, sensitivity: { en: "Confidential", zh: "机密" }, time: { en: "10 min ago", zh: "10 分钟前" }, action: { en: "Generated", zh: "生成" } },
